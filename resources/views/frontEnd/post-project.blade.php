...
<div class="col-lg-9 col-md-9">
  <form class="form-horizontal" role="form" action="{{route('storeProject')}}" method="POST" enctype="multipart/form-data">
                    
                      {{ csrf_field() }}
   <div class="card padding-card">
    <div class="card-body">
     <h5 class="card-title mb-4">Project Posting</h5>
     <div class="row">
...
@endif
      ...
      <div class="form-group col-md-6">
        ...
        <textarea type="text" name="address" placeholder="Enter Address" required class="form-control" rows="1"></textarea>
...
<div class="form-group col-md-6">
 ...
 <input type="text" class="form-control no-radius" name="budget" required="required" placeholder="Budget">
...
<div class="form-group col-md-12">
 <label>Project Description <span class="text-danger">*</span></label>
   <textarea type="text" name="description" placeholder="Project Description" required class="form-control" rows="5"></textarea>

    ...
    <div class="col-md-12 col-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <div class="form-body">
                <form novalidate action="{{ route('roles.store') }}" method="POST" enctype="multipart/form-data">
                       @csrf
                                       ...
                                       <tr>
                                        ...
                                        <td>
                                            <div class="checkbox"><input type="checkbox"
                                                id="users-checkbox{{$key}}1" class="checkbox-input" value="{{$module}}-list" name="permission[]">
                                                <label for="users-checkbox{{$key}}1"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox"
                                                id="users-checkbox{{$key}}2" class="checkbox-input" value="{{$module}}-edit" name="permission[]"><label
                                                for="users-checkbox{{$key}}2"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox"
                                                id="users-checkbox{{$key}}3" class="checkbox-input" value="{{$module}}-create" name="permission[]"><label
                                                for="users-checkbox{{$key}}3"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="checkbox"><input type="checkbox"
                                                id="users-checkbox{{$key}}4" class="checkbox-input" value="{{$module}}-delete" name="permission[]">
